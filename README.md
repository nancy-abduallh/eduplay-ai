...
EduPlayAI is a Laravel-based platform that leverages **OpenAI** and **YouTube Data API v3** to generate curated educational playlists from simple text prompts. Users can input topics (e.g., "linear algebra", "machine learning") and get a list of high-quality YouTube playlists instantly. The application features real‑time progress tracking, a modern dark/light theme, and a responsive mobile sidebar.
...
| MySQL               | Database                                        |
| OpenAI API          | Natural language processing for topics          |
